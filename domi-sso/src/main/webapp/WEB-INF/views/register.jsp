...
<head>
    ...
    <title>注册-个人用户</title>
    <link type="text/css" rel="stylesheet" href="http://static.domi.com/css/regist.personal.css"/>
    <link type="text/css" rel="stylesheet" href="http://static.domi.com//css/passport.base.css"/>
...
<div class="w" id="logo">
    <div>
    	<a href="http://www.taotao.com/">
    		<img src="http://static.domi.com//images/taotao-logo.gif" alt="京东商城" width="170" height="60"/>
    	</a> <b></b>
    </div>
</div>
...
<div class="w" id="regist">
    ...
    <div class="mc">
        <form id="personRegForm" method="post" onsubmit="return false;">
            ...
            <div class="phone">
                <img width="180" height="180" src="http://static.domi.com//images/phone-bg.jpg">
            </div>
                        <span class="clr"></span>
        </form>
    </div>
...
<script type="text/javascript" src="http://static.domi.com//js/register/jd.lib.js"></script>
<script type="text/javascript" src="http://static.domi.com//js/register/jdThickBox.js"></script>
<script type="text/javascript" src="http://static.domi.com//js/register/jdValidate.js"></script>
<script type="text/javascript" src="http://static.domi.com//js/register/jdValidate.emReg.js"></script>
<script type="text/javascript" src="http://static.domi.com//js/register/jdValidate.regSuccess.js"></script>
